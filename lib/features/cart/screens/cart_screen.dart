...
class CartScreenState extends State<CartScreen> {
  ...
  void changeColor() {
    setState(() {
      _currentColor = (_currentColor == Theme.of(Get.context!).cardColor) ? Colors.grey.withValues(alpha: 0.15) : Theme.of(Get.context!).cardColor;
          ...
          builder: (context, shippingController, _) {
            return Consumer<CartController>(
              builder: (context, cart, child) {
                ...
                // }
                // In your CartScreen build method, add this listener:
                shippingAmount = shippingController.calculateTotalShippingCost() - freeDeliveryAmountDiscount;
                                  ...
                                  ? Column(
                                      children: [
                                            ...
                                            children: [
                                              ...
                                              Consumer<ShippingController>(
                                                builder: (context, shippingController, child) {
                                                  return Text(
                                                    PriceConverter.convertPrice(context, amount + tax + shippingAmount),
                                                    style: titilliumSemiBold.copyWith(
                                                      color: Provider.of<ThemeController>(context, listen: false).darkTheme ? Theme.of(context).hintColor : Theme.of(context).primaryColor,
                                                      fontSize: Dimensions.fontSizeLarge,
                                                    ),
                                        ...
                                        InkWell(
                                            ...
                                            if (configProvider.configModel!.shippingMethod == 'sellerwise_shipping') {
                                              for (int index = 0; index < cartProductList.length; index++) {
                                                for (CartModel cart in cartProductList[index]) {
                                                  if (cart.productType == 'physical' && sellerGroupList[index].shippingType == 'order_wise' && Provider.of<ShippingController>(context, listen: false).shippingList![index].shippingIndex == -1) {
                                                    hasNull = true;
                                                    break;
                                                  }
                                                }
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(color: Theme.of(context).primaryColor, borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall)),

                                            child: Center(
                                              child: Padding(
                                                padding: EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.fontSizeSmall),
                                                child: Text(
                  ...
                  body: Column(
                    children: [
                      cart.cartLoading
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                      ...
                                                      ? Padding(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(
                                                                width: 200,
                                                                child: configProvider.configModel!.shippingMethod == 'sellerwise_shipping' && sellerGroupList[index].shippingType == 'order_wise' && hasPhysical
                                                                    ? Padding(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      (shippingController.shippingList == null ||
                                                                              ...
                                                                              shippingController.shippingList![index].shippingIndex == -1)
                                                                          ? ''
                                                                          : PriceConverter.convertPrice(context, shippingController.shippingList![index].shippingMethodList![shippingController.shippingList![index].shippingIndex!].cost),
                                                                      style: textBold.copyWith(),
                                                                      maxLines: 1,
                                                                      overflow: TextOverflow.ellipsis,
                                                                      textAlign: TextAlign.end,
                                                        ...
                                                        children: [
                                                          ListView.builder(
                                                            ...
                                                            itemBuilder: (context, i) {
                                                              return CartWidget(cartModel: cartProductList[index][i], index: cartProductIndexList[index][i], fromCheckout: widget.fromCheckout);
                                                            },
                                                          ),
                                                        ],
                                                      ),
                                                  ...
                                                  if (sellerGroupList[index].freeDeliveryOrderAmount?.status == 1 && hasPhysical)
                                                    Padding(
                                                      padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeSmall, left: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeDefault, top: Dimensions.paddingSizeSmall),
                                                      child: Row(
                                                        children: [
                                                          SizedBox(
                                                            height: 16,
                                                            child: Image.asset(Images.freeShipping, color: Provider.of<ThemeController>(context, listen: false).darkTheme ? Theme.of(context).hintColor : Theme.of(context).primaryColor),
                                                          ),
                                                  ...
                                                  if (sellerGroupList[index].freeDeliveryOrderAmount?.status == 1 && hasPhysical)
                                                    Padding(
                                                      ...
                                                      child: LinearPercentIndicator(
                                                        ...
                                                        backgroundColor: Provider.of<ThemeController>(context, listen: false).darkTheme ? Theme.of(context).primaryColor.withOpacity(.5) : Theme.of(context).primaryColor.withOpacity(.2),
                                                        progressColor: (sellerGroupList[index].freeDeliveryOrderAmount!.percentage! < 100 && !Provider.of<ThemeController>(context, listen: false).darkTheme)
                          ...
                          : const Expanded(
                              child: NoInternetOrDataScreenWidget(icon: Images.emptyCart, icCart: true, isNoInternet: false, message: 'no_product_in_cart'),
                            ),
                    ],
                  ),
                );
