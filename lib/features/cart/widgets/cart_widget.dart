            ...
            child: Slidable(
              ...
              endActionPane: ActionPane(
                ...
                children: [
                  SlidableAction(
                    onPressed: (value) {
                      cartProvider.removeFromCart(cartModel?.id, index);
                    },
              ...
              child: Row(
                ...
                children: [
                      ...
                      child: Stack(
                        children: [
                          Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                              border: Border.all(color: Theme.of(context).primaryColor.withValues(alpha: 0.10), width: 0.5),
                            ),
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                              child: CustomImageWidget(image: '${splashController.baseUrls?.productThumbnailUrl}/${cartModel?.thumbnail}', height: 70, width: 70),
                            ),
                          ),
                          if (cartModel!.isProductAvailable! == 0)
                            Container(
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall), color: Colors.black.withValues(alpha: 0.5)),
                              height: 70,
                              width: 70,
                              child: Center(
                                child: Text(
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  style: textMedium.copyWith(
                                    ...
                                    color: (cartModel!.shop != null && (cartModel!.shop!.temporaryClose! || cartModel!.shop!.vacationStatus!)) ? Theme.of(context).hintColor : ColorResources.getReviewRattingColor(context),
                                  ),
                                ),
                              ),
                            ...
                            children: [
                              cartModel!.discount! > 0
                                  ? Text(
                                      ...
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      style: titilliumSemiBold.copyWith(color: Theme.of(context).hintColor, decoration: TextDecoration.lineThrough),
                                    )
                                  : const SizedBox(),
                              SizedBox(width: Dimensions.fontSizeSmall),

                              Text(
                                PriceConverter.convertPrice(context, cartModel!.price, discount: cartModel!.discount, discountType: 'amount'),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: textBold.copyWith(
                                  color: (cartModel!.shop != null && (cartModel!.shop!.temporaryClose! || cartModel!.shop!.vacationStatus!)) ? Theme.of(context).hintColor : ColorResources.getPrimary(context),
                                    ...
                                    children: [
                                      Flexible(
                                        child: Text(
                                          ...
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: ColorResources.getReviewRattingColor(context)),
                                        ),
                                      ),
                                    ],
                                  ),
                          ...
                          cartModel!.taxModel == 'exclude'
                              ? Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: textRegular.copyWith(color: ColorResources.hintTextColor, fontSize: Dimensions.fontSizeDefault),
                                  ),
                                )
                              : Padding(
                                  padding: const EdgeInsets.only(top: Dimensions.paddingSizeExtraSmall),
                  ...
                  Container(
                    ...
                    width: 40,
                    height: (cartModel!.shippingType != 'order_wise' && cartModel!.variant != null && cartModel!.variant!.isNotEmpty)
                        ? 185
                        : (cartModel!.variant != null && cartModel!.variant!.isNotEmpty && cartModel!.shippingType == 'order_wise')
                        ? 125
                        : (cartModel!.variant == null && cartModel!.shippingType != 'order_wise')
                        ? 160
                        : 150,
                    child: Padding(
