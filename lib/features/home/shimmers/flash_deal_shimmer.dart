    ...
    return Padding(
      ...
      child: Column(
        children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              height: ResponsiveHelper.isTab(context) ? 70 : 50,
                          ...
                          Container(
                            height: ResponsiveHelper.isTab(context) ? 70 : 50,
                            width: ResponsiveHelper.isTab(context) ? 70 : 50,
                            padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                            decoration: BoxDecoration(color: ColorResources.iconBg(), borderRadius: BorderRadius.circular(10)),
                          ),
                          const SizedBox(width: 20),
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 50, vertical: Dimensions.paddingSizeSmall),
            child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      height: ResponsiveHelper.isTab(context) ? 30 : 10,
                      padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                      decoration: BoxDecoration(color: ColorResources.iconBg(), borderRadius: BorderRadius.circular(2)),
                    ),
                  ],
                ),
              ),
