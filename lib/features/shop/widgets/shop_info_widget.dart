        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: Provider.of<ThemeController>(context, listen: false).darkTheme ? null : [BoxShadow(color: Colors.grey.withValues(alpha: 0.3), spreadRadius: 1, blurRadius: 5)],
            ),
            child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: CustomImageWidget(height: 80, width: 80, fit: BoxFit.cover, image: '${Provider.of<SplashController>(context, listen: false).baseUrls!.shopImageUrl}/$shopImage'),
                      ),
                    ),
                    if (temporaryClose || vacationIsOn)
                      Container(
                        width: 80,
                        height: 80,
                        decoration: BoxDecoration(color: Colors.black.withValues(alpha: 0.5), borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeExtraSmall))),
                      ),
                                    ...
                                    if (vacationIsOn || temporaryClose) {
                                      ...
                                      if (!Provider.of<AuthController>(context, listen: false).isLoggedIn()) {
                                        ...
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => ChatScreen(id: sellerId, name: sellerName),
                                          ),
                                        );
                                      }
                                    }
